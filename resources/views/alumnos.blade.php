                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach($alumnos as $elemento)
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="text-info" href="{{ action('alumnosController@edit', ['id' => $elemento->id]) }}">  <i class='fas fa-pen-square'></i> Editar</a>
                                <a class="text-danger" href="{{ action('alumnosController@destroy', ['id' => $elemento->id]) }}"> <i class='fas fa-trash-alt'></i>Eliminar</a>
                             </td>
                        </tr>
                    @endforeach
                    </tbody>
